...
class QuantumLoaderApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: const LoadingShowcasePage(),
    );
  }
}

class LoadingShowcasePage extends StatefulWidget {
  const LoadingShowcasePage({super.key});

  @override
  State<LoadingShowcasePage> createState() => _LoadingShowcasePageState();
}

class _LoadingShowcasePageState extends State<LoadingShowcasePage>
